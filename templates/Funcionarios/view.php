...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(__('Deletar Funcionario'), ['action' => 'delete', $funcionario->id], ['confirm' => __('Você tem certeza que deseja apagar {0}?', $funcionario->id), 'class' => 'side-nav-item']) ?>
